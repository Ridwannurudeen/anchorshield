...
> Honesty rule baked into the gates: each one demands the *independent/external/licensed* version.
...
4. Migrate admin: call `transfer_admin(<governance_contract_id>)` on all eight governed contracts
   (`docs/MAINNET_RUNBOOK.md` step 5).

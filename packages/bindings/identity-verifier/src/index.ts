...
export interface Client {
   ...
   */
  attest: ({account, proof, pub_signals, policy_id, epoch, valid_until}: {account: string, proof: Proof, pub_signals: Array<u256>, policy_id: u32, epoch: u32, valid_until: u64}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
   ...
   */
  rwa_token: ({asset_id}: {asset_id: u32}, options?: MethodOptions) => Promise<AssembledTransaction<Option<string>>>
   ...
   */
  rwa_recipient: ({recipient_id}: {recipient_id: u128}, options?: MethodOptions) => Promise<AssembledTransaction<Option<string>>>
   ...
   */
  set_rwa_token: ({asset_id, token}: {asset_id: u32, token: string}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
   ...
   */
  attest_for_mint: ({account, consumer, proof, pub_signals, policy_id, asset_id, amount, recipient_id, action_id, terms_hash, epoch, valid_until}: {account: string, consumer: string, proof: Proof, pub_signals: Array<u256>, policy_id: u32, asset_id: u32, amount: i128, recipient_id: u128, action_id: u128, terms_hash: u256, epoch: u32, valid_until: u64}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
   ...
   */
  recovery_target: ({old_account}: {old_account: string}, options?: MethodOptions) => Promise<AssembledTransaction<Option<string>>>
   ...
   * token operation.
   */
  verify_identity: ({account}: {account: string}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
   ...
   */
  set_rwa_recipient: ({recipient_id, account}: {recipient_id: u128, account: string}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
   ...
   */
  attestation_expiry: ({account}: {account: string}, options?: MethodOptions) => Promise<AssembledTransaction<Option<u64>>>
   ...
   */
  mint_authorization: ({consumer, token, account}: {consumer: string, token: string, account: string}, options?: MethodOptions) => Promise<AssembledTransaction<Option<MintAuthorization>>>
   ...
   */
  allow_mint_consumer: ({consumer}: {consumer: string}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
   ...
   */
  revoke_mint_consumer: ({consumer}: {consumer: string}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
   ...
   */
  is_mint_consumer_allowed: ({consumer}: {consumer: string}, options?: MethodOptions) => Promise<AssembledTransaction<boolean>>
   ...
   */
  consume_mint_authorization: ({consumer, token, account, amount}: {consumer: string, token: string, account: string, amount: i128}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "",

...
export const Errors = {
  ...
  20: { message: "AnonymitySetTooSmall" },
  21: { message: "NotPauser" },
  22: { message: "NoPendingAdmin" },
};
...
export interface Client {
   ...
   */
  fund: (
    { asset_id, amount }: { asset_id: u32; amount: i128 },
   ...
   */
  holding: (
    { asset_id, recipient }: { asset_id: u32; recipient: u128 },
    options?: MethodOptions,
